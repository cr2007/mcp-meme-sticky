...
COPY ./src/mcp_sticky/__init__.py /app/mcp_sticky/__init__.py
COPY ./src/mcp_sticky/main.py /app/mcp_sticky/main.py
ADD ./src/mcp_sticky/resources /app/mcp_sticky/resources
ADD ./src/mcp_sticky/utils /app/mcp_sticky/utils
